...
$doc->addScript('https://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js', 'text/javascript', true);
if ($params['developer_mode']) {
// Load expanded css and js files
$doc->addScript($this->baseurl . '/templates/' . $this->template . '/js/dev/app-dev.js', 'text/javascript', true);
// Add Stylesheets
...
// Add Stylesheets
$doc->addStyleSheet($this->baseurl . '/templates/' . $this->template . '/css/app-min.css');
}
...
<div class="toprow">
  <div class="row">
    <div class="large-12">
    <jdoc:include type="modules" name="header-sh" />
    </div>
    <div class="large-12 columns region1menu">
    <!-- Nav Bar -->
      <nav class="top-bar " data-topbar>
        <ul class="title-area hide-for-medium-up">
          <li class="name"><a href="#"><?php echo $sitename;?></a></li>
